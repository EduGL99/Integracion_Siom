...
public class WorkOrderTO implements java.io.Serializable, NamedNodeTO, NodeTO {
    ...
    public static class Builder {
        ...
        public WorkOrderTO build() {
            return new WorkOrderTO(id, workOrderType, workOrderTemplate, name, description, owner, creationDate, installDate, assignedTo, index, status, priority, equipmentToAdd, equipmentToRemove, linksToAdd, linksToRemove, images, files, comments, location, properties, project, checkListCategories, hyperlinks, closeDate);
        }
