...
public class WorkOrdersQueryRequest implements GraphQLOperationRequest {
    ...
    public void setFilterBy(java.util.List<WorkOrderFilterInputTO> filterBy) {
    ...
    public static class Builder {
        ...
        private java.util.List<WorkOrderFilterInputTO> filterBy;
        ...
        public Builder setFilterBy(java.util.List<WorkOrderFilterInputTO> filterBy) {
        ...
        public WorkOrdersQueryRequest build() {
            WorkOrdersQueryRequest obj = new WorkOrdersQueryRequest();
            obj.setAfter(after);
            obj.setFirst(first);
