...
public class TokenController {
    ...
    private static String client_id="8N1KY91ItwQab7Fi2Ctiq5TYEs0a" ;
    private static String client_secret="sGvfwQyBuePnAqHNlDBAk6fXZHUa" ;
    ...
    private static String client_id="b794315b-7401-47a0-ba65-f2346ac0157b";
    private static String client_secret="qX6uC1iW2oI0aN7yH2dF6cJ0vG0pR2mB5sG2iV4vA2bN6jQ0kC";
    private static String url_dir="https://api-saac.apiconnect.ibmcloud.com/saacmovistarcommx-prod/t-open-api-temm/oauth2/v1/token";
    ...
    public String generarTokenWSO2(){
        ...
        try {
            ...
            // si el token es diferente de vacio y nulo, retorna el token, en caso contrario regresa null
