...
public class ServicesQueryRequest implements GraphQLOperationRequest {
    ...
    public void setFilterBy(java.util.List<ServiceFilterInputTO> filterBy) {
    ...
    public static class Builder {
        ...
        private java.util.List<ServiceFilterInputTO> filterBy;
        ...
        public Builder setFilterBy(java.util.List<ServiceFilterInputTO> filterBy) {
        ...
        public ServicesQueryRequest build() {
            ServicesQueryRequest obj = new ServicesQueryRequest();
            obj.setAfter(after);
            obj.setFirst(first);
