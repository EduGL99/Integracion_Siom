...
public class AddLocationTypeInputTO implements java.io.Serializable {
    ...
    public AddLocationTypeInputTO(String name, String mapType, Integer mapZoomLevel, Boolean isSite, java.util.List<PropertyTypeInputTO> properties, java.util.List<SurveyTemplateCategoryInputTO> surveyTemplateCategories) {
        this.name = name;
    ...
    public static class Builder {
        ...
        public AddLocationTypeInputTO build() {
            return new AddLocationTypeInputTO(name, mapType, mapZoomLevel, isSite, properties, surveyTemplateCategories);
        }
