...
public class WorkOrderTypeTO implements java.io.Serializable, NodeTO {
    ...
    public WorkOrderTypeTO(String id, String name, String description, java.util.List<PropertyTypeTO> propertyTypes, Integer numberOfWorkOrders, java.util.List<CheckListCategoryDefinitionTO> checkListCategoryDefinitions, Boolean assigneeCanCompleteWorkOrder) {
        this.id = id;
        this.name = name;
