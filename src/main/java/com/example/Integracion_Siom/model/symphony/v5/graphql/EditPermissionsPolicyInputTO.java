...
public class EditPermissionsPolicyInputTO implements java.io.Serializable {
    ...
    public EditPermissionsPolicyInputTO(String id, String name, String description, Boolean isGlobal, InventoryPolicyInputTO inventoryInput, WorkforcePolicyInputTO workforceInput, AutomationPolicyInputTO automationInput, java.util.List<String> groups) {
        this.id = id;
        this.name = name;
    ...
    public static class Builder {
        ...
        public EditPermissionsPolicyInputTO build() {
            return new EditPermissionsPolicyInputTO(id, name, description, isGlobal, inventoryInput, workforceInput, automationInput, groups);
        }
