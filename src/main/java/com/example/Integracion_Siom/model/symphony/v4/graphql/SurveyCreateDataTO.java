...
public class SurveyCreateDataTO implements java.io.Serializable {
    ...
    public SurveyCreateDataTO(String name, String ownerName, Integer creationTimestamp, Integer completionTimestamp, SurveyStatusTO status, String locationID, java.util.List<SurveyQuestionResponseTO> surveyResponses) {
        this.name = name;
