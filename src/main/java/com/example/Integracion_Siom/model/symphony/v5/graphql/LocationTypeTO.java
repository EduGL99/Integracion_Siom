...
public class LocationTypeTO implements java.io.Serializable, NodeTO {
    ...
    public LocationTypeTO(String id, String name, String mapType, boolean isSite, Integer index, Integer mapZoomLevel, java.util.List<PropertyTypeTO> propertyTypes, int numberOfLocations, LocationConnectionTO locations, java.util.List<SurveyTemplateCategoryTO> surveyTemplateCategories) {
        this.id = id;
        this.name = name;
    ...
    public static class Builder {
        ...
        public LocationTypeTO build() {
            return new LocationTypeTO(id, name, mapType, isSite, index, mapZoomLevel, propertyTypes, numberOfLocations, locations, surveyTemplateCategories);
        }
