...
public class UserTO implements java.io.Serializable, NamedNodeTO, NodeTO {
    ...
    public UserTO(String id, String authID, String firstName, String lastName, String name, String email, UserStatusTO status, UserRoleTO role, FileTO profilePhoto, java.util.List<UsersGroupTO> groups, DistanceUnitTO distanceUnit) {
        this.id = id;
        this.authID = authID;
    ...
    public static class Builder {
        ...
        public UserTO build() {
            return new UserTO(id, authID, firstName, lastName, name, email, status, role, profilePhoto, groups, distanceUnit);
        }
