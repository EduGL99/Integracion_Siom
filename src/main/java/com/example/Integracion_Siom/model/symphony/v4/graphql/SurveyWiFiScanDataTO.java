...
public class SurveyWiFiScanDataTO implements java.io.Serializable {
    ...
    public SurveyWiFiScanDataTO(Integer timestamp, Integer frequency, Integer channel, String bssid, Integer strength, String ssid, String band, Integer channelWidth, String capabilities, Double latitude, Double longitude, Double altitude, Double heading, Double rssi) {
