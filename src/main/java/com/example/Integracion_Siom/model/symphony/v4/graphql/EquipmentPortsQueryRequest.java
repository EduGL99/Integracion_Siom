...
public class EquipmentPortsQueryRequest implements GraphQLOperationRequest {
    ...
    public void setFilterBy(java.util.List<PortFilterInputTO> filterBy) {
    ...
    public static class Builder {
        ...
        private java.util.List<PortFilterInputTO> filterBy;
        ...
        public Builder setFilterBy(java.util.List<PortFilterInputTO> filterBy) {
        ...
        public EquipmentPortsQueryRequest build() {
            EquipmentPortsQueryRequest obj = new EquipmentPortsQueryRequest();
            obj.setAfter(after);
            obj.setFirst(first);
