...
public class UsersQueryRequest implements GraphQLOperationRequest {
    ...
    public void setFilterBy(java.util.List<UserFilterInputTO> filterBy) {
    ...
    public static class Builder {
        ...
        private java.util.List<UserFilterInputTO> filterBy;
        ...
        public Builder setFilterBy(java.util.List<UserFilterInputTO> filterBy) {
