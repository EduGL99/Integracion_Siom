...
public class WorkforcePermissionRuleTO implements java.io.Serializable {
    ...
    public WorkforcePermissionRuleTO(PermissionValueTO isAllowed, java.util.List<String> projectTypeIds, java.util.List<String> workOrderTypeIds) {
    ...
    public static class Builder {
        ...
        public WorkforcePermissionRuleTO build() {
            return new WorkforcePermissionRuleTO(isAllowed, projectTypeIds, workOrderTypeIds);
        }
