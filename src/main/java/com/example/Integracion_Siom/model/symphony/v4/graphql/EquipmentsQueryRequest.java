...
public class EquipmentsQueryRequest implements GraphQLOperationRequest {
    ...
    public void setFilterBy(java.util.List<EquipmentFilterInputTO> filterBy) {
    ...
    public static class Builder {
        ...
        private java.util.List<EquipmentFilterInputTO> filterBy;
        ...
        public Builder setFilterBy(java.util.List<EquipmentFilterInputTO> filterBy) {
        ...
        public EquipmentsQueryRequest build() {
            EquipmentsQueryRequest obj = new EquipmentsQueryRequest();
            obj.setAfter(after);
            obj.setFirst(first);
