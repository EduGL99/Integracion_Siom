...
public class FileTO implements java.io.Serializable, NodeTO {
    ...
    public FileTO(String id, String fileName, Integer sizeInBytes, String modified, String uploaded, FileTypeTO fileType, String mimeType, String storeKey, String category, String annotation) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public FileTO build() {
            return new FileTO(id, fileName, sizeInBytes, modified, uploaded, fileType, mimeType, storeKey, category, annotation);
        }
