...
public class LocationsQueryRequest implements GraphQLOperationRequest {
    ...
    public void setFilterBy(java.util.List<LocationFilterInputTO> filterBy) {
    ...
    public static class Builder {
        ...
        private java.util.List<LocationFilterInputTO> filterBy;
        ...
        public Builder setFilterBy(java.util.List<LocationFilterInputTO> filterBy) {
        ...
        public LocationsQueryRequest build() {
            LocationsQueryRequest obj = new LocationsQueryRequest();
