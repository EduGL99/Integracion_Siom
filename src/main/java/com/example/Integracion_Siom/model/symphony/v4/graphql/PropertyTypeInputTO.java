...
public class PropertyTypeInputTO implements java.io.Serializable {
    ...
    public static class Builder {
        ...
        public PropertyTypeInputTO build() {
            return new PropertyTypeInputTO(id, externalId, name, type, nodeType, index, category, stringValue, intValue, booleanValue, floatValue, latitudeValue, longitudeValue, rangeFromValue, rangeToValue, isEditable, isInstanceProperty, isMandatory, isDeleted);
        }
