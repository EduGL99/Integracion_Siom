...
public class InventoryPolicyInputTO implements java.io.Serializable {
    ...
    public InventoryPolicyInputTO(BasicPermissionRuleInputTO read, LocationCUDInputTO location, BasicCUDInputTO equipment, BasicCUDInputTO equipmentType, BasicCUDInputTO locationType, BasicCUDInputTO portType, BasicCUDInputTO serviceType) {
        this.read = read;
    ...
    public static class Builder {
        ...
        public InventoryPolicyInputTO build() {
            return new InventoryPolicyInputTO(read, location, equipment, equipmentType, locationType, portType, serviceType);
        }
