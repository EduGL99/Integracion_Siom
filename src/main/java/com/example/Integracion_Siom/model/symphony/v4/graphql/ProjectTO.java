...
public class ProjectTO implements java.io.Serializable, NamedNodeTO, NodeTO {
    ...
    public ProjectTO(String id, String name, String description, ProjectPriorityTO priority, UserTO createdBy, String createTime, ProjectTypeTO type, ProjectTemplateTO template, LocationTO location, java.util.List<WorkOrderTO> workOrders, Integer numberOfWorkOrders, java.util.List<PropertyTO> properties, java.util.List<CommentTO> comments) {
        this.id = id;
        this.name = name;
