...
public class EditWorkOrderTypeInputTO implements java.io.Serializable {
    ...
    public EditWorkOrderTypeInputTO(String id, String name, String description, java.util.List<PropertyTypeInputTO> properties, java.util.List<CheckListCategoryDefinitionInputTO> checkListCategories, Boolean assigneeCanCompleteWorkOrder) {
        this.id = id;
        this.name = name;
    ...
    public static class Builder {
        ...
        public EditWorkOrderTypeInputTO build() {
            return new EditWorkOrderTypeInputTO(id, name, description, properties, checkListCategories, assigneeCanCompleteWorkOrder);
        }
